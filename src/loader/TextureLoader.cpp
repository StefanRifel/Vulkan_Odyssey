...
void TextureLoader::createTextureImage(std::string texturePath, VkImage& textureImage, VkDeviceMemory& textureImageMemory) {
    ...
    void* data;
    vkMapMemory(LogicalDeviceWrapper::getVkDevice(), stagingBufferMemory, 0, imageSize, 0, &data);
...
VkImageView TextureLoader::createImageView(VkImage image, VkFormat format, VkImageAspectFlags aspectFlags) {
