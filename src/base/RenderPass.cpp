...
void RenderPass::createRenderPass() {
    ...
    if (vkCreateRenderPass(LogicalDeviceWrapper::getVkDevice(), &renderPassInfo, nullptr, &renderPass) != VK_SUCCESS) {
...
GraphicsPipeline RenderPass::createGraphicsPipelineSkybox(std::string vertShaderPath, std::string fragShaderPath) {
    auto vertShaderCode = readFile(vertShaderPath);
    auto fragShaderCode = readFile(fragShaderPath);
